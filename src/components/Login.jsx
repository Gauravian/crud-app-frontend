            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 shadow-xl">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form action="#" method="POST" className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="mt-2 flex ">
                                ...
                                />
                                <div className='btn   border-b-gray-400 rounded-l-none ' onClick={()=>setpassshow(!passshow)}>{!passshow ? <FaEyeSlash/> : <FaEye/>}</div>
                    ...
                    <p className="mt-10 text-center text-sm text-gray-500">
                       ...
                       <NavLink to='/register' className="font-semibold leading-6 text-indigo-600 underline hover:text-indigo-500">Register</NavLink>
                    </p>
                </div>
            </div>
        </>
